...
Cross-references to the [Networking learning path](../networking/INDEX.md), the [Java learning path](../java/INDEX.md) (Spring Security tier), the [TypeScript learning path](../typescript/INDEX.md), the [Kubernetes learning path](../kubernetes/INDEX.md) (Pod Security, RBAC), and the [System Design learning path](../system-design/INDEX.md) (security tier) where topics overlap.
