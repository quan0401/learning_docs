...
**Tags:** `system-design` `case-study` `async` `scheduling` `medium`
**LLD Twin:** [Task Scheduler (LLD) — Job, Trigger, Executor Pool Classes](../../../low-level-design/case-studies/developer-tools/design-task-scheduler.md) — class-level OOD with entities, relationships, and patterns.
