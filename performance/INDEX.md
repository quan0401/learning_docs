...
Cross-references to the [System Design learning path](../system-design/INDEX.md), the [Java learning path](../java/INDEX.md), the [TypeScript learning path](../typescript/INDEX.md), the [Database learning path](../database/INDEX.md), the [Networking learning path](../networking/INDEX.md), the [Observability learning path](../observability/) (in progress), and the [Operating Systems learning path](../operating-systems/INDEX.md) (in progress) where topics overlap.
